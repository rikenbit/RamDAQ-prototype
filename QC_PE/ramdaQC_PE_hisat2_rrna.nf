...
process run_hisat2  {
    ...
    input:
    val proj_id
    set run_id, fastq_L_name, fastq_R_name, fastq_name, fastq_L, fastq_R, option_name, option, strandedness_name, strandedness, index_name, index, pipeline_class from hisat2_conditions

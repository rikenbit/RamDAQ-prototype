...
process collect_RSeQC_summary_readDist {
    ...
    if( pipeline_class[0] == 'stranded' )
        ...
        """
         python $readdist_script_path $PWD/output_$proj_id/$run_id/05_rseqc/read_distribution unstranded summary_RSeQC_ReadDist_results_PE_sort
        """
}
...
process collect_RSeQC_summary_geneBC {
    ...
    if( pipeline_class[0] == 'stranded' )
        ...
        """
         python $genebc_script_path $PWD/output_$proj_id/$run_id/05_rseqc/gene_bodycoverage unstranded summary_RSeQC_geneBC_results_PE_sort
        """
}
